class TicksController < ApplicationController
  ...
  def create
    @user = current_user
    @tick = @user.ticks.new(tick_params)

    respond_to do |format|
      if @tick.save
        format.html { redirect_to root_path, notice: 'Tick was successfully created.' }
  ...
  private
    ...
    def tick_params
      params.require(:tick).permit(:new_tick, :detail, :user_id)
    end
end
